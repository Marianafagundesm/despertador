...
public class SwitchCase {
    ...
    public static void mapaPessoal () {
       String[] mes = {"Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Setembro", "Outubro", "Novembro", "Dezembro"};
       ...
       for (int i = 0; i < mes.length; i++) {
        ...
        try {
            ...
            switch (respostaUsuario) {
                case 0:
                    System.out.println("Você digitou a opção de: "+ mes [respostaUsuario]); break;
                case 1:
                    System.out.println("Você digitou a opção de: "+ mes [respostaUsuario]); break;
                case 2:
                    System.out.println("Você digitou a opção de: "+ mes [respostaUsuario]); break;
